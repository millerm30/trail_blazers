...
import imageTen from "../assets/red_beach/photo10.jpg";
import imageEleven from "../assets/red_beach/photo11.jpg";
import imageTwelve from "../assets/red_beach/photo12.jpg";
import imageThirteen from "../assets/red_beach/photo13.jpg";
import imageFourteen from "../assets/red_beach/photo14.jpg";
import imageFifteen from "../assets/red_beach/photo15.jpg";

const PhotoCarousel = () => {
  return (
    <div className="carousel w-11/12 mx-auto my-4 md:w-1/2 lg:w-1/3">
      <CarouselSlider slideNumber={"slide1"} imageSrc={imageOne} slideBack={"#slide15"} slideAhead={"#slide2"} />
      ...
      <CarouselSlider slideNumber={"slide9"} imageSrc={imageNine} slideBack={"#slide8"} slideAhead={"#slide10"} />
      <CarouselSlider slideNumber={"slide10"} imageSrc={imageTen} slideBack={"#slide9"} slideAhead={"#slide11"} />
      <CarouselSlider slideNumber={"slide11"} imageSrc={imageEleven} slideBack={"#slide10"} slideAhead={"#slide12"} />
      <CarouselSlider slideNumber={"slide12"} imageSrc={imageTwelve} slideBack={"#slide11"} slideAhead={"#slide13"} />
      <CarouselSlider slideNumber={"slide13"} imageSrc={imageThirteen} slideBack={"#slide12"} slideAhead={"#slide14"} />
      <CarouselSlider slideNumber={"slide14"} imageSrc={imageFourteen} slideBack={"#slide13"} slideAhead={"#slide15"} />
      <CarouselSlider slideNumber={"slide15"} imageSrc={imageFifteen} slideBack={"#slide14"} slideAhead={"#slide1"} />
    </div>
  );
};
